...
export default function GenrePage() {
  ...
  const fetchMangaByGenre = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/manga?genre=${encodeURIComponent(genre)}`);
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-black transition-colors duration-300 pt-16 font-sans">
        <div className="container mx-auto px-4 py-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading {formattedGenre} manga...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black transition-colors duration-300 pt-16 font-sans">
      <div className="container mx-auto px-4">
        {/* Same spacing as manga page - pt-4 md:pt-12 */}
        <div className="pt-4 md:pt-12 pb-8">
          ...
          {mangaList.length === 0 ? (
            <div className="text-center py-12 bg-white dark:bg-gray-900 rounded-xl border border-gray-300 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">No {formattedGenre} Manga Available</h3>
